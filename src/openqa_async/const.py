...
to use 'from openqa_async.const import *'; this will only import
sanely named 'constants'. You may prefer to do `from openqa_async
...
JOB_NOT_OK_RESULTS = (
    (JOB_RESULT_FAILED,) + JOB_NOT_COMPLETE_RESULTS + JOB_ABORTED_RESULTS
)
